...
* Plot2: Create DMDB;
*------------------------------------------------------------*;
proc dmdb batch data=EMWS1.Clus_TRAIN
...
proc gchart
data=EMWS1.Clus_TRAIN gout=WORK.Plot2GRAPH;
*;
...
*------------------------------------------------------------*;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\AffluenceGrade by TargetBuy.png";
...
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\CampaignViewedEmail by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay CAMPAIGN;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\CleanserProducts by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay CLEANSER;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\DayCareProducts by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay DAYCAREP;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\FacebookLike by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay FACEBOOK;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\LotionProducts by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay LOTIONPR;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\LoyaltyClass by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay LOYALTYC;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\MobileApplications by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay MOBILEAP;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\NightRepairProducts by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay NIGHTREP;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\PreviousCampaign by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay PREVIOUS;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_AdvertisementZone by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_ADVE;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_Age by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_AGE;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_ClusterGroup by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_CLUS;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_Gender by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_GEND;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_LoyaltyTime by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_LOYA;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\REP_Region by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay REP_REGI;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\TimeSinceLastPurchase by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay TIMESINC;
quit;
goptions device=win;
filename gsasfile;
filename gsasfile "D:\Nida\Data mining\datamining\BOGO\Workspaces\EMWS1\Plot2\GRAPH\TotalSpend by TargetBuy.png";
goptions device= PNG display gaccess= gsasfile gsfmode= replace cback= white;
proc greplay igout=WORK.PLOT2GRAPH nofs;
replay TOTALSPE;
quit;
