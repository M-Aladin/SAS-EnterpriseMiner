...
*------------------------------------------------------------*;
proc freq data=EMWS1.Filter4_TRAIN noprint;
format
TargetBuy BEST12.0
;
table
...
*------------------------------------------------------------*;
data
EMWS1.Part5_TRAIN(label="")
EMWS1.Part5_VALIDATE(label="")
;
retain _seed_ 12345;
...
_Pformat1 = '0'
then do;
if (2527+1-_C000003)*_genvalue_ <= (1264 - _C000001) then do;
_C000001 + 1;
output EMWS1.Part5_TRAIN;
end;
else do;
_C000002 + 1;
output EMWS1.Part5_VALIDATE;
end;
_C000003+1;
end;
else if
_Pformat1 = '1'
then do;
if (1420+1-_C000006)*_genvalue_ <= (710 - _C000004) then do;
_C000004 + 1;
output EMWS1.Part5_TRAIN;
end;
else do;
