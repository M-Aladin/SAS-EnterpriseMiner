...
*------------------------------------------------------------*;
proc freq data=EMWS4.Filter_TRAIN noprint;
format
TargetBuy BEST12.0
;
table
...
*------------------------------------------------------------*;
data
EMWS4.Part3_TRAIN(label="")
EMWS4.Part3_VALIDATE(label="")
;
retain _seed_ 12345;
...
_Pformat1 = '0'
then do;
if (15033+1-_C000003)*_genvalue_ <= (7517 - _C000001) then do;
_C000001 + 1;
output EMWS4.Part3_TRAIN;
end;
else do;
_C000002 + 1;
output EMWS4.Part3_VALIDATE;
end;
_C000003+1;
end;
else if
_Pformat1 = '1'
then do;
if (5002+1-_C000006)*_genvalue_ <= (2501 - _C000004) then do;
_C000004 + 1;
output EMWS4.Part3_TRAIN;
end;
else do;
