...
%let EM_NUM_VARS = 8;
   %macro EM_VARS;
    CampaignViewedEmail DayCareProducts FacebookLike MobileApplications No
   PreviousCampaign TargetBuy _SEGMENT_
   %mend EM_VARS;
%let EM_NUM_CLASS = 7;
   %macro EM_CLASS;
    CampaignViewedEmail FacebookLike MobileApplications No PreviousCampaign
   TargetBuy _SEGMENT_
   %mend EM_CLASS;
...
%let EM_NUM_INPUT = 5;
   %macro EM_INPUT;
    CampaignViewedEmail DayCareProducts FacebookLike MobileApplications
   PreviousCampaign
   %mend EM_INPUT;
