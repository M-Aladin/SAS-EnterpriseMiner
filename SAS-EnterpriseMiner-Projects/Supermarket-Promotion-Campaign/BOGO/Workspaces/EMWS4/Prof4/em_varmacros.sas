...
%let EM_NUM_VARS = 21;
   ...
   No PreviousCampaign REP_AdvertisementZone REP_Age REP_ClusterGroup REP_Gender
   REP_LoyaltyTime REP_Region TargetBuy TimeSinceLastPurchase TotalSpend _SEGMENT_
   %mend EM_VARS;
%let EM_NUM_CLASS = 12;
   %macro EM_CLASS;
    CampaignViewedEmail FacebookLike LoyaltyClass MobileApplications No
...
%let EM_NUM_INPUT = 18;
   ...
   REP_LoyaltyTime REP_Region TimeSinceLastPurchase TotalSpend
   %mend EM_INPUT;
...
%let EM_NUM_REJECTS = 9;
   %macro EM_REJECTS;
    AdvertisementZone Age ClusterGroup Distance Gender LoyaltyTime Region
   TargetAmt _SEGMENT_LABEL_
   %mend EM_REJECTS;
