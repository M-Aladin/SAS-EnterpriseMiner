...
* NODE: MdlComp;
*------------------------------------------------------------*;
if (P_TargetBuy1 ge 0.75275510823017) then do;
b_TargetBuy = 1;
end;
else
if (P_TargetBuy1 ge 0.62517829157409) then do;
b_TargetBuy = 2;
end;
else
if (P_TargetBuy1 ge 0.50716971819273) then do;
b_TargetBuy = 3;
end;
else
if (P_TargetBuy1 ge 0.42237807563009) then do;
b_TargetBuy = 4;
end;
else
if (P_TargetBuy1 ge 0.3548480809288) then do;
b_TargetBuy = 5;
end;
else
if (P_TargetBuy1 ge 0.30063837830924) then do;
b_TargetBuy = 6;
end;
else
if (P_TargetBuy1 ge 0.25677240889424) then do;
b_TargetBuy = 7;
end;
else
if (P_TargetBuy1 ge 0.22037217267925) then do;
b_TargetBuy = 8;
end;
else
if (P_TargetBuy1 ge 0.1879403017122) then do;
b_TargetBuy = 9;
end;
else
if (P_TargetBuy1 ge 0.16118088446118) then do;
b_TargetBuy = 10;
end;
else
if (P_TargetBuy1 ge 0.1383495909848) then do;
b_TargetBuy = 11;
end;
else
if (P_TargetBuy1 ge 0.11889286061525) then do;
b_TargetBuy = 12;
end;
else
if (P_TargetBuy1 ge 0.10208575579086) then do;
b_TargetBuy = 13;
end;
else
if (P_TargetBuy1 ge 0.08681453323517) then do;
b_TargetBuy = 14;
end;
else
if (P_TargetBuy1 ge 0.07207632000671) then do;
b_TargetBuy = 15;
end;
else
if (P_TargetBuy1 ge 0.05898787157504) then do;
b_TargetBuy = 16;
end;
else
if (P_TargetBuy1 ge 0.04809342115634) then do;
b_TargetBuy = 17;
end;
else
if (P_TargetBuy1 ge 0.03801491389072) then do;
b_TargetBuy = 18;
end;
else
if (P_TargetBuy1 ge 0.0293745310967) then do;
b_TargetBuy = 19;
end;
else
do;
