if NAME = "EP_TARGETBUY" then ROLE = 'REJECTED';
if NAME = "I_TargetBuy" then ROLE = 'REJECTED';
if NAME = "P_TargetBuy0" then ROLE = 'REJECTED';
if NAME = "P_TargetBuy1" then ROLE = 'REJECTED';
